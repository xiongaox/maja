        ...
        <form onSubmit={handleCreate} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-800 focus:outline-none focus:ring-2 focus:ring-amber-500 transition-shadow"
            />
            <p className="text-xs text-slate-400 mt-2">
